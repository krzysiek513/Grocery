...
public class AddProductActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        discountedNoteEt = findViewById(R.id.discounedNotetEt);
    ...
    private void inputData() {
        ...
        if (TextUtils.isEmpty(productTitle)){
            Toast.makeText(this, "Title is requiered.", Toast.LENGTH_SHORT).show();
            return;
        }
        if (TextUtils.isEmpty(productCategory)){
            Toast.makeText(this, "Category is requiered.", Toast.LENGTH_SHORT).show();
            return;
        }
        if (TextUtils.isEmpty(originalPrice)){
            Toast.makeText(this, "Price is requiered.", Toast.LENGTH_SHORT).show();
            return;
        }
        if (discountAvailable){
            ...
            if (TextUtils.isEmpty(discountPrice)){
                Toast.makeText(this, "Discount Price is requiered.", Toast.LENGTH_SHORT).show();
                return;
            }
        }
        else {
